...
def feature_prediction(arg, train_data, test_data, index):
    ...
    args["epochs"] = 20
    args["batch_size"] = 128
    if arg.data_name=="stock":
        args["in_dim"] = dim-1
    else:
        args["in_dim"] = dim
    args["h_dim"] = arg.hidden_dim
    args["out_dim"] = 1
    args["n_layers"] = arg.num_layers
    args["dropout"] = 0.5
    args["padding_value"] = arg.padding_value
    args["max_seq_len"] = arg.max_seq_len
...
def one_step_ahead_prediction(arg, train_data, test_data):
    ...
    args["max_seq_len"] = arg.max_seq_len - 1   # only 99 is used for prediction
    args["learning_rate"] = 1e-3
    args["grad_clip_norm"] = 5.0
